...
The problem with SEO is that there's so much to learn, it's a vast domain of knowledge, with many branches that could each take up thier own websites of related links.
...
Most of those optimizations revolve around gradually making every individual piece of code on your site more machine readable, and so that it communicates essential bits of information to a variety of connecting sites\services that make it stand out from the crowd.
...
You'll likely find many valuable links, but nothing that presents all of the links you need in one place.

Or your fine tune into a particular aspect that isn't well indexed.
