...
* [#indieweb-dev on DIDs 2019-03-02-chat log](https://freenode.logbot.info/indieweb-dev/20190302)
  ...
  * 16:16 [@aaronpk](https://twitter.com/aaronpk) -DIDs lost me when they make the assumption that blockchains are the only resolution mechanism
  ...
  * 16:17 [@aaronpk](https://twitter.com/aaronpk) -any examples yet?
  ...
  * 16:18 [@aaronpk](https://twitter.com/aaronpk) -Even just reading w3c-ccg.github.io/did-primer/#the-format-of-a-did-0 they casually drop a mention of blockchain as the only option
  ...
  * 16:18 [@aaronpk](https://twitter.com/aaronpk) -I'd recommend revising that sentence if they want to not have people think that
  ...
  * 16:19 [@aaronpk](https://twitter.com/aaronpk) -From what I understand they have no interest in relying on DNS so that takes them completely out of the realm of working with current browsers or anything like IndieAuth
  * 16:20 [@aaronpk](https://twitter.com/aaronpk) -in theory you could make a dns resolver method for did and use domain names as the identifier and get close to something like IndieAuth
  ...
  * 16:22 [@aaronpk](https://twitter.com/aaronpk) -The other thing missing from DID is the authorization framework that comes with IndieAuth since it's built on OAuth 2.0
  ...
  * 16:23 [@aaronpk](https://twitter.com/aaronpk) -The DID and OIDC groups weren't even getting along very well and while OIDC is way overkill for what we use IndieAuth for, its still more similar to IndieAuth than blockchain stuff is
  ...
  * 16:26 [@aaronpk](https://twitter.com/aaronpk) -I would be very interested in what you come up with. I haven't had much luck in any of these conversations so far
  ...
  * 16:28 [@aaronpk](https://twitter.com/aaronpk) -Yep and https://aaronparecki.com/2018/07/07/7/oauth-for-the-open-web is a good explanation too
  * 16:28 [@aaronpk](https://twitter.com/aaronpk) - oh did I forget a change log section? I'll try to add that
  * 16:29 [@sandhawke](https://twitter.com/sandhawke) - +1
  * 16:30 [@aaronpk](https://twitter.com/aaronpk) - If video is more your thing, I gave this talk at the W3C workshop [youtube.com/watch?v=EeCNlB7v08I](https://youtube.com/watch?v=EeCNlB7v08I)
  * 16:30 [@aaronpk](https://twitter.com/aaronpk) - its nice and short
  ...
  * 17:01 [@aaronpk](https://twitter.com/aaronpk) - Yeah that's from OAuth. Prevents redirect interception by registering the redirect URL, and also helps the user not get phished
  ...
  * 21:05 [@swentel](https://github.com/swentel) - [tantek], yeah, I figured that it might be a useful link for people looking for my 'main' feed
  * 21:06 [@swentel](https://github.com/swentel) - also because currently in aperture, rel="feed" is ignored. So if people search feeds on realize.be, they will get microformats, but that's on my homepage, which is kind of useless
  * 21:06 [@swentel](https://github.com/swentel) - which makes me wonder whether I should remove microformat markup on the homepage maybe
  * 21:08 [@swentel](https://github.com/swentel) - (to be more specific, xray underneath ignores rel="feed", but that's technical detail)
  * 21:09 [@swentel](https://github.com/swentel) - other than that, fun experiments today with checkins and geocache, I'm getting excited by the location stuff in indigenous :)
  ...
  * 21:11 [@aaronpk](https://twitter.com/aaronpk) - jacky: we actually started experimenting with this
  ...
  * 21:12 [@aaronpk](https://twitter.com/aaronpk) - trying to remember where we documented it? it was a quick thing during IWC Austin
  * 21:12 [[jacky]](https://indieweb.org/User:Jacky.wtf) - oh man
  * 21:12 [@aaronpk](https://twitter.com/aaronpk) - GWG added it to wordpress and I added it to Quill
  * 21:12 [@swentel](https://github.com/swentel) - hmm, GWG opened an issue for me indigenous, there's probably a link there, let me check
  * 21:12 [@swentel](https://github.com/swentel) - indieweb/indieauth #31
  * 21:12 [[Loqi]](https://indieweb.org/Loqi) - [dshanske] #31 Returning Profile Data
  * 21:13 [[jacky]](https://indieweb.org/User:Jacky.wtf) - nice
  * 21:13 [@swentel](https://github.com/swentel) - that's at least the indieauth thing
  * 21:13 [@swentel](https://github.com/swentel) - maybe there's more?
  * 21:13 [@aaronpk](https://twitter.com/aaronpk) - yep thanks
  ...
  * 21:13 [@aaronpk](https://twitter.com/aaronpk) - hrm I don't think it should be "nickname"
  ...
  * 21:14 [@aaronpk](https://twitter.com/aaronpk) - display name is more accurate
  ...
  * 21:15 [@aaronpk](https://twitter.com/aaronpk) - the other reason for doing this is it means it's easier to return private/sensitive profile data to apps without having to have a way to serve protected data from your home page
  ...
  * 21:16 [@swentel](https://github.com/swentel) - Hmm, I like name tbh :)
  * 21:16 [@aaronpk](https://twitter.com/aaronpk) - I also don't necessarily think "name" is a bad property for this, just need to make it clear that there is no expectation of a "real name" or "full name"
  * 21:16 [@swentel](https://github.com/swentel) - as it's consistent then
  * 21:16 [@aaronpk](https://twitter.com/aaronpk) - there isn't any expectation of that in this stuff anyway so I don't really see the problem
  ...
  * 21:17 [@aaronpk](https://twitter.com/aaronpk) - Zegnat: what gave you the idea of that from jf2? jf2 shouldn't be defining any new semantics on top of the mf2 properties
  * 21:18 [@swentel](https://github.com/swentel) - GWG, do you have a link to the commit in wordpress?
  * 21:18 [@swentel](https://github.com/swentel) - Just for inspiration
  ...
  * 21:19 [@swentel](https://github.com/swentel) - thanks
  ...
  * 21:22 [@swentel](https://github.com/swentel) - just wanted to make sure it exists at least
  * 21:22 [@aaronpk](https://twitter.com/aaronpk) - side note: openid connect has "name", "family_name", "given_name", "middle_name" and "nickname" all under the "profile" scope, and tbh is an example of what tantek is talking about where the only one actually used is just "name" 
  ...
  * 21:23 [@swentel](https://github.com/swentel) - GWG, on micropub extensions?
  * 21:23 [[GWG]](https://indieweb.org/User:David.shanske.com) - Swentel, yes, excuse me.
  * 21:23 [@swentel](https://github.com/swentel) - Ok, maybe it's better to move it there completely
  ...
  * 21:26 [@aaronpk](https://twitter.com/aaronpk) - GWG: I'd hold off on anything further with this until we get more publishers and consumers of it
  ...
  * 21:28 [@swentel](https://github.com/swentel) - [tantek], oh, interesting, I'll give that a try yes!
  ...
  * 21:31 [@aaronpk](https://twitter.com/aaronpk) - whoa swentel indieweb.org/Micropub-extensions#Location_checkin_information
  ...
  * 21:31 [@aaronpk](https://twitter.com/aaronpk) - that's like an embedded h-card in a geo URL?
  * 21:31 [@aaronpk](https://twitter.com/aaronpk) - URI
  * 21:31 [@swentel](https://github.com/swentel) - aaronpk, yeah, works great .. (at least for me)
  ...
  * 21:32 [@swentel](https://github.com/swentel) - I can post checkins and geocaches now from indigenous, with pictures, all in one go :)
  * 21:32 [@swentel](https://github.com/swentel) - it's GREAT ;)
  * 21:32 [@aaronpk](https://twitter.com/aaronpk) - [tantek]: re: geo URI? I thought URLs had to be resolvable
...
* [#indieweb-dev on IIW 2018-08-19-chat log](https://freenode.logbot.info/indieweb-dev/20180819)
  * 17:08 [@aaronpk](https://twitter.com/aaronpk) - No, IIW
  * 17:09 [@aaronpk](https://twitter.com/aaronpk) - but all the OAuth IETF people will be there
  ...
  * 17:09 [@aaronpk](https://twitter.com/aaronpk) - I wonder how much of this I can write in the next 2 hours
  * 17:09 [@aaronpk](https://twitter.com/aaronpk) - need a name tho
  * 17:10 [[kevinmarks]](http://www.kevinmarks.com/) - OpenAppID
  * 17:10 [@aaronpk](https://twitter.com/aaronpk) - Oh no
  ...
  * 17:11 [@aaronpk](https://twitter.com/aaronpk) - OAuth came out of IIW
  ...
  * 17:12 [@aaronpk](https://twitter.com/aaronpk) - A lot of it was done at IIW regardless of where it started exactly
  ...
  * 17:14 [@aaronpk](https://twitter.com/aaronpk) - What I meant was OAuth would not have succeeded if it had not been discussed at IIW
  ...
  * 17:16 [@aaronpk](https://twitter.com/aaronpk) - I need a name that gets across that client registration is replaced by DNS
  * 17:16 [@aaronpk](https://twitter.com/aaronpk) - I would use “implicit client registration” if “implicit” didn’t already have existing meaning in OAuth
  ...
  * 17:21 [@aaronpk](https://twitter.com/aaronpk) - PKCE is a great name because it’s easily googleable and also pronounceable (pixie)
  ...
  * 17:23 [@aaronpk](https://twitter.com/aaronpk) - zorg omg
